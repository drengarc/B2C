...
{
    public partial class AramaSonuc : TanitimSablon
    {
        private AramaSonucCntrl kulcntrl = new AramaSonucCntrl();
        #region Constructors
        public AramaSonuc()
        {
            
            InitializeComponent();
            tabloAdi = "W_ARAMA_SONUC";
        ...
        {
          AramaSonucVm k = new AramaSonucVm();
        ...
        {
            AramaSonucVm k = (AramaSonucVm)ModelVm;
