...
{
    public partial class Alanlar : TanitimSablon
    {
        #region degiskenler
       ...
       //   gridView1.Columns["ID"].Visible = false;
        ...
        public void DbyeEkle(AlanlarVm vm)
        {
            ...
            else if (vm.M_ALAN_TIP_ID == (int)AlanTipEn.COMBOBOX || vm.M_ALAN_TIP_ID == (int)AlanTipEn.EVETHAYIR || vm.M_ALAN_TIP_ID == (int)AlanTipEn.TAMSAYI)
            {
               dataTip = "int";
            }
            ...
            else if (vm.M_ALAN_TIP_ID == (int)AlanTipEn.TARIH)
            {
                dataTip = "SmallDateTime";
            }
            else if (vm.M_ALAN_TIP_ID == (int)AlanTipEn.TEXTBOX)
            {
                dataTip = "VarChar(" + vm.ALAN_UZUNLUK + ")";
            }
            else if (vm.M_ALAN_TIP_ID == (int)AlanTipEn.TAMSAYI)
            {
                dataTip = "int";
            }
            else if (vm.M_ALAN_TIP_ID == (int)AlanTipEn.TARIHTAM)
            {
                dataTip = "DateTime";
            }
