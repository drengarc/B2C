    ...
    public partial class YetkiIslemler : TanitimSablon
    {
        ...
        public override void Custom_Buton_Islemleri(string islem)
        {
            if (islem == "KopyalamaUstBilgi")
            {
                ...
                if (YardimciIslemlerKontrols.UyariVer("Secili Satır" + Vm.YETKILI_ISLEM_SAHIBI_AD + " İşlemlerine Kopyalanacaktır. Emin Misiniz?") == true)
                {
            ...
            {
                YetkiIslemlerVm Vm = (YetkiIslemlerVm)ModelVm;
                if (YardimciIslemlerKontrols.UyariVer("Secili Satır Tüm İşlemlere Kopyalanacaktır. Emin Misiniz?") == true)
                {
