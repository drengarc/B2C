    ...
    public partial class YetkiMenuler : Islemler
    {
        ...
        public void usrTabPage_Index_Changed(int index)
        {
            if (index != 0)
            {
                ...
                YardimciIslemlerKontrols.InvokeLkeSet("M_MENU_UST_ID", menuLke1);
                menuLke2.Properties.DataSource = ListDenemeService.GetM_MENU_ID_BY_PARAM(0, 0);
                WinFormsHelper.GridLookUpEditDuzenle(menuLke2);
        ...
        private void menuLke1_EditValueChanged(object sender, EventArgs e)
        {
            ...
            menuLke2.Properties.DataSource = Prodma.DataAccessB2C.ListDenemeService.GetM_MENU_ID_BY_PARAM(0, ust_id);
            WinFormsHelper.GridLookUpEditDuzenle(menuLke2);
        ...
        private void menuLke2_EditValueChanged(object sender, EventArgs e)
        {
            ...
            menuLke3.Properties.DataSource = Prodma.DataAccessB2C.ListDenemeService.GetM_MENU_ID_BY_PARAM(0, ust_id);
            WinFormsHelper.GridLookUpEditDuzenle(menuLke3);
        }
