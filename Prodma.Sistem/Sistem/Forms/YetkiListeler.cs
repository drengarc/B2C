...
{
    public partial class YetkiListeler : TanitimSablon
    {
        #region degiskenler
      ...
      //      panel2.Controls.Add(yBilgi.controlNavigator1);
        ...
        public override void Custom_Buton_Islemleri(string islem)
        {
            if (islem == "KopyalamaUstBilgi")
            {
                ...
                if (YardimciIslemlerKontrols.UyariVer("Secili Satır" + Vm.YETKILI_ISLEM_SAHIBI_AD + " Listelerine Kopyalanacaktır. Emin Misiniz?") == true)
                {
                    OrtakIslemlerService.KullaniciIslemListeYetkiKopyala(Vm, true, (int)IslemListeEn.LISTE);
            ...
            {
                YetkiIslemlerVm Vm = (YetkiIslemlerVm)ModelVm;
                if (YardimciIslemlerKontrols.UyariVer("Secili Satır Tüm Listelere Kopyalanacaktır. Emin Misiniz?") == true)
                {
                    OrtakIslemlerService.KullaniciIslemListeYetkiKopyala(Vm, false, (int)IslemListeEn.LISTE);
                    MessageBox.Show("İşlem Tamamlandı");
                    Doldur();
                }
            }
        ...
        {
            yetkiIslemlerVm.ListeFiltresi = "2";
