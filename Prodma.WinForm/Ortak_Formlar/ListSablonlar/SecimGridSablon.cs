...
namespace Prodma.WinForms
{
    ...
    public partial class SecimGridSablon : Sablon
    {
        ...
        public SecimGridSablon()
        {
            ...
            usr.ButonMenuOlustur += usrButonMenuOlustur;
            usr.controlNavigatorButtonClick += controlNavigatorButtonClick;
        }
        public void usrButonMenuOlustur(object sender, EventArgs e)
        {
            butonMenuOlustur();
        }
        ...
        public virtual void butonMenuOlustur()
        {
        }
        public virtual void MenuClick(string islem)
        {
        }
        ...
        {
            MenuClick(e.Button.Tag.ToString());
        }
