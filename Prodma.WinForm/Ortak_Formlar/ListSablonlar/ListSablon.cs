...
namespace Prodma.WinForms
{
    ...
    public partial class ListSablon : Sablon
    {
        ...
        void Listele()
        {
            ...
            ParametreSet();
            ReportParameterSet();
            WinFormsHelper.Grid_Olustur(ListeOzellikleri.modelPath, ListeOzellikleri.modelName, "Prodma.DataAccess", gridControl.gridView1, ListeOzellikleri.toplamAlanlari, null);
            Goster();
        }
