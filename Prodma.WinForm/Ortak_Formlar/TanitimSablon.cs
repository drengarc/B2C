...
namespace Prodma.WinForms
{
    ...
    public partial class TanitimSablon : Sablon
    {
        ...
        public TanitimSablon()
        {
            ...
            EkranListeleri[1] = new BarButtonItem(barManager1, "Excell");
            EkranListeleri[1].Name = "Excell";
            this.popupMenu1.LinksPersistInfo.Add(new DevExpress.XtraBars.LinkPersistInfo(EkranListeleri[1]));
            Type hai = this.GetType();
            string name = hai.ToString();
            MenulerVm fVm = new MenulerVm();
            fVm.URL = name;
            MenulerCntrl cntrl = new MenulerCntrl();
           // MessageBox.Show("geldi" + name);
            //yetki = ListDenemeService.GetYETKI_MENULER(name);
            //MessageBox.Show("bitti" + name);
            ...
            gridView1.AppearancePrint.GroupRow.ForeColor = Color.Blue;
            gridView1.GroupFormat = "[#image]{1} {2}";
            //gridView1.Appearance.Row.Font = new Font(Globals.sablonFontFamilyName, Globals.sablonFontSize);
        }
        ...
        public void TanitimSablon_Load(object sender, EventArgs e)
        {
            ...
            if (yetki != null && yetki.GORMESIN_E_H == (int)EvetHayirEn.Evet)
            {
            }
            else
            {
        ...
        public void yetKiAyarla(YetkiMenulerVm yetki)
        {
            if (yetki != null)
            {
                if (yetki.GORMESIN_E_H == (int)EvetHayirEn.Evet || yetki.OKU_E_H == (int)EvetHayirEn.Hayir)
                {
                ...
                {
                    if (yetki.YAZ_E_H == (int)EvetHayirEn.Hayir)
                    {
                        kayitEtme = false;
                    }
                    if (yetki.GUNCELLE_E_H == (int)EvetHayirEn.Hayir)
                    {
                        guncelleme = false;
                    }
                    if (yetki.SIL_E_H == (int)EvetHayirEn.Hayir)
                    {
                        silme = false;
                    }
                }
                if (yetki.OKU_E_H == (int)EvetHayirEn.Evet || (yetki.YAZ_E_H == (int)EvetHayirEn.Hayir && yetki.GUNCELLE_E_H == (int)EvetHayirEn.Hayir && yetki.SIL_E_H == (int)EvetHayirEn.Hayir))
                {
                    //this.gridView1.OptionsBehavior.Editable = false;
                }
                if (yetki.OKU_E_H == (int)EvetHayirEn.Hayir || yetki.YAZ_E_H == (int)EvetHayirEn.Hayir || yetki.GUNCELLE_E_H == (int)EvetHayirEn.Hayir || yetki.SIL_E_H == (int)EvetHayirEn.Hayir)
                {
                    tamYetki = false;
                }
                else
            ...
            foreach (var ALAN in q)
            {
              ...
              //  Column1.VisibleIndex = 1;// Convert.ToInt32(ALAN.ALAN_SIRA);
                ...
                if (ALAN.M_ALAN_TIP_ID == (int)AlanTipEn.TEXTBOX)  // TEXT
                {
                    ...
                    repositoryItemTextEdit[intBind].MaxLength = ALAN.ALAN_UZUNLUK == null ? 5 : Convert.ToInt32(ALAN.ALAN_UZUNLUK); 
        ...
        public string Gridi_Olustur()//GRÝD ve ARAMALAR AYARLANIYOR
        {
            ...
            try
            {
                ...
                foreach (var ALAN in q)
                {
                    ...
                    Column1.FieldName = ALAN.ALAN_AD;
                    Column1.Name = ALAN.ALAN_AD;
                    alanListeAd = ALAN.ALAN_LISTE_AD;
                    Column1.Caption = Globals.rman.GetString(ALAN.ALAN_LISTE_AD);
                    Column1.Width = ALAN.ALAN_LISTE_GENISLIK == null ? 5 : Convert.ToInt32(ALAN.ALAN_LISTE_GENISLIK);
                    // Column1.BestFit();  
                    Column1.Visible = true;
                    Column1.VisibleIndex = ALAN.ALAN_SIRA == null ? 5 : Convert.ToInt32(ALAN.ALAN_SIRA); //Convert.ToInt32(ALAN.ALAN_SIRA);
                    if (ALAN.M_ALAN_CLASS_NAME != null) { Column1.Tag = Convert.ToString(ALAN.M_ALAN_CLASS_NAME) + "/" + Convert.ToString(ALAN.ID); }
                    if ((ALAN.GORMESIN_E_H == (int)EvetHayirEn.Evet && ALAN.M_ALANLAR_ALT_ID == null) || ALAN.M_ALAN_TIP_2 == 2)
                    {
                        Column1.Visible = false;
                    ...
                    else if (ALAN.M_ALAN_TIP_ID == (int)AlanTipEn.TARIH)//TARIH
                    {
                        ...
                        new DevExpress.XtraEditors.Controls.EditorButton()});
                        this.gridControl1.RepositoryItems.Add(repositoryItemDateEdit);
                        //this.repositoryItemDateEdit.Mask.EditMask = "yyyy-MM-dd HH:mm:ss.fffffff";
                        //this.repositoryItemDateEdit.Mask.UseMaskAsDisplayFormat = true;
                        Column1.FilterMode = DevExpress.XtraGrid.ColumnFilterMode.DisplayText;
                        //Column1.DisplayFormat.FormatString = "t";
                        Column1.ColumnEdit = repositoryItemDateEdit;
                        //this.repositoryItemDateEdit.ParseEditValue += new DevExpress.XtraEditors.Controls.ConvertEditValueEventHandler(repositoryItemDateEdit_ParseEditValue);
            ...
            string formText = Globals.rman.GetString(tabloAdi);
            return formText!=null ? formText : tabloAdi;
        }
        void repositoryItemDateEdit_ParseEditValue(object sender, DevExpress.XtraEditors.Controls.ConvertEditValueEventArgs e)
        {
            if (e.Value == null) return;
            DateTimeOffset dto = DateTimeOffset.MinValue;
            bool result = DateTimeOffset.TryParse(e.Value.ToString(), out dto);
            if (result)
            {
                e.Value = dto;
                e.Handled = true;
        ...
        public void KodIsteyenFisSet(FisSablonSon frFis, GridControl gridControl, GridView view, DevExpress.XtraGrid.Columns.GridColumn column)
        {
            fisfrm1 = frFis;
        ...
        private void InitializeComponent()
        {
            ...
            this.gridControl1.Size = new System.Drawing.Size(936, 487);
            ...
            // toolTipController1
            // 
            this.toolTipController1.Appearance.Font = new System.Drawing.Font("Tahoma", 12.25F);
            ...
            this.toolTipController1.ReshowDelay = 3;
            // 
            // panelControl1
            // 
            ...
            this.panelControl1.Size = new System.Drawing.Size(948, 0);
            ...
            this.pnlIslemler.Location = new System.Drawing.Point(2, -41);
            ...
            this.pnlEkIslemler.Location = new System.Drawing.Point(2, -21);
            ...
            this.pnlArama.Location = new System.Drawing.Point(2, 1);
            this.pnlArama.Name = "pnlArama";
            this.pnlArama.Size = new System.Drawing.Size(944, 0);
            ...
            this.BILGI1_cmd.Location = new System.Drawing.Point(2, 1);
            ...
            this.tabControl1.Size = new System.Drawing.Size(948, 521);
            ...
            this.tabPage1.Size = new System.Drawing.Size(942, 493);
            ...
            this.tabPage2.Size = new System.Drawing.Size(942, 493);
            ...
            new DevExpress.XtraEditors.NavigatorCustomButton(-1, 9, true, true, "Kaydet", ""),
            new DevExpress.XtraEditors.NavigatorCustomButton(-1, 10, true, true, "Vacgec", "")});
            this.controlNavigator2.Dock = System.Windows.Forms.DockStyle.Bottom;
            this.controlNavigator2.Location = new System.Drawing.Point(3, 450);
            this.controlNavigator2.Name = "controlNavigator2";
            this.controlNavigator2.Size = new System.Drawing.Size(936, 40);
            ...
            this.tabPage3.Size = new System.Drawing.Size(942, 493);
            ...
            this.controlNavigator3.Location = new System.Drawing.Point(3, 450);
            this.controlNavigator3.Name = "controlNavigator3";
            this.controlNavigator3.Size = new System.Drawing.Size(936, 40);
            ...
            this.tabPage4.Size = new System.Drawing.Size(942, 493);
            ...
            this.controlNavigator4.Location = new System.Drawing.Point(3, 450);
            this.controlNavigator4.Name = "controlNavigator4";
            this.controlNavigator4.Size = new System.Drawing.Size(936, 40);
            ...
            this.tabPage5.Size = new System.Drawing.Size(942, 493);
            ...
            this.controlNavigator5.Location = new System.Drawing.Point(3, 450);
            this.controlNavigator5.Name = "controlNavigator5";
            this.controlNavigator5.Size = new System.Drawing.Size(936, 40);
            ...
            this.tabPage6.Size = new System.Drawing.Size(942, 493);
            ...
            this.controlNavigator6.Location = new System.Drawing.Point(3, 450);
            this.controlNavigator6.Name = "controlNavigator6";
            this.controlNavigator6.Size = new System.Drawing.Size(936, 40);
            ...
            this.tabPage7.Size = new System.Drawing.Size(942, 493);
            ...
            this.controlNavigator7.Location = new System.Drawing.Point(3, 450);
            this.controlNavigator7.Name = "controlNavigator7";
            this.controlNavigator7.Size = new System.Drawing.Size(936, 40);
            ...
            this.tabPage8.Size = new System.Drawing.Size(942, 493);
            ...
            this.controlNavigator8.Location = new System.Drawing.Point(3, 450);
            this.controlNavigator8.Name = "controlNavigator8";
            this.controlNavigator8.Size = new System.Drawing.Size(936, 40);
            ...
            this.tabPage9.Size = new System.Drawing.Size(942, 493);
            ...
            this.controlNavigator9.Location = new System.Drawing.Point(3, 450);
            this.controlNavigator9.Name = "controlNavigator9";
            this.controlNavigator9.Size = new System.Drawing.Size(936, 40);
            ...
            this.tabPage10.Size = new System.Drawing.Size(942, 493);
            ...
            this.controlNavigator10.Location = new System.Drawing.Point(3, 450);
            this.controlNavigator10.Name = "controlNavigator10";
            this.controlNavigator10.Size = new System.Drawing.Size(936, 40);
            ...
            this.tabPage11.Size = new System.Drawing.Size(942, 493);
            ...
            this.controlNavigator11.Location = new System.Drawing.Point(3, 450);
            this.controlNavigator11.Name = "controlNavigator11";
            this.controlNavigator11.Size = new System.Drawing.Size(936, 40);
            ...
            this.tabPage12.Size = new System.Drawing.Size(942, 493);
            ...
            this.controlNavigator12.Location = new System.Drawing.Point(3, 450);
            this.controlNavigator12.Name = "controlNavigator12";
            this.controlNavigator12.Size = new System.Drawing.Size(936, 40);
            ...
            this.tabPage13.Size = new System.Drawing.Size(942, 493);
            ...
            this.controlNavigator13.Location = new System.Drawing.Point(3, 450);
            this.controlNavigator13.Name = "controlNavigator13";
            this.controlNavigator13.Size = new System.Drawing.Size(936, 40);
        ...
        public virtual void RowStyle(object sender, DevExpress.XtraGrid.Views.Grid.RowStyleEventArgs e) { }
        ...
        private void controlNavigator1_ButtonClick(object sender, DevExpress.XtraEditors.NavigatorButtonClickEventArgs e)//Override yeni kayýt/guncelle/sil/ilerigerisatirolustur iþlemi Yapýlýyor.
        {
            ...
            else if (e.Button == navigator.Buttons.EndEdit)//Kaydete basildiginda grid tabinda ise
            {
                ...
                if (yeniSatir == false)
                {
                    if (yetki==null || (yetki.YAZ_E_H == (int)EvetHayirEn.Evet || yetki.YAZ_E_H == null))
                    {
                        this.Kaydet();
                    }
                    else
 ...
 DevExpress.XtraEditors.GridLookUpEdit)
                 ...
                 else if (e.KeyCode == Keys.T)
                 {
                     ...
                     TextBoxBuyut byt = new TextBoxBuyut(Convert.ToString(this.gridView1.GetRowCellValue(this.gridView1.FocusedRowHandle, this.gridView1.FocusedColumn)));
                     byt.ShowDialog();
                     if (byt.yaziVerilen != "")
                     {
                         gridView1.SetRowCellValue(gridView1.FocusedRowHandle, gridView1.FocusedColumn, byt.yaziVerilen);
                     }
        ...
        private void gridView1_ShownEditor(object sender, EventArgs e)
        {
            ...
            if (gridView.FocusedColumn.FieldName == "EKIPMAN_OPERASYON_CINS_ID" && gridView.ActiveEditor is
DevExpress.XtraEditors.GridLookUpEdit)
            {
                ...
                int ust_id = Convert.ToInt32(this.gridView1.GetRowCellValue(introw, "EKIPMAN_OPERASYON_AYRIM_ID"));
                if (ust_id != 0)
                {
                    //edit.Properties.DataSource = ListDenemeService.GetEKIPMAN_OPERASYON_CINS_BY_PARAM(0, ust_id);
