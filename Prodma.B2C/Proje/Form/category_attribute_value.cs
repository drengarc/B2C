...
namespace B2C.Forms
{
    public partial class category_attribute_value : TanitimSablon
    {
        #region degiskenler
        private category_attribute_valueCntrl kulcntrl = new category_attribute_valueCntrl();
        #endregion
        #region Constructors
        public category_attribute_value()
        {
            InitializeComponent();
            tabloAdi = "category_attribute_value";
        ...
        {
            category_attribute_valueVm k = new category_attribute_valueVm();
        ...
        {
            category_attribute_valueVm k = (category_attribute_valueVm)ModelVm;
