...
namespace B2C.Forms
{
    public partial class category_attribute_schema : TanitimSablon
    {
        #region degiskenler
        private category_attribute_schemaCntrl kulcntrl = new category_attribute_schemaCntrl();
        #endregion
        #region Constructors
        public category_attribute_schema()
        {
            InitializeComponent();
            tabloAdi = "category_attribute_schema";
        ...
        {
            category_attribute_schemaVm k = new category_attribute_schemaVm();
        ...
        {
            category_attribute_schemaVm k = (category_attribute_schemaVm)ModelVm;
