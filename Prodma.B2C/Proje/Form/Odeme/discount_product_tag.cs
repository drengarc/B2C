...
namespace B2C.Forms
{
    public partial class discount_product_tag : TanitimSablon
    {
        #region degiskenler
        private discount_product_tagCntrl kulcntrl = new discount_product_tagCntrl();
        #endregion
        #region Constructors
        public discount_product_tag()
        {
            InitializeComponent();
            tabloAdi = "discount_product_tag";
        ...
        {
            discount_product_tagVm k = new discount_product_tagVm();
        ...
        {
            discount_product_tagVm k = (discount_product_tagVm)ModelVm;
