...
namespace B2C.Forms
{
    public partial class payment_package : TanitimSablon
    {
        #region degiskenler
        private payment_packageCntrl kulcntrl = new payment_packageCntrl();
        #endregion
        #region Constructors
        public payment_package()
        {
            InitializeComponent();
            tabloAdi = "payment_package";
        ...
        {
            payment_packageVm k = new payment_packageVm();
        ...
        {
            payment_packageVm k = (payment_packageVm)ModelVm;
