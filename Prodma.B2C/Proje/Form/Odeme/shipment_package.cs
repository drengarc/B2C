...
namespace B2C.Forms
{
    public partial class shipment_package : TanitimSablon
    {
        #region degiskenler
        private shipment_packageCntrl kulcntrl = new shipment_packageCntrl();
        #endregion
        #region Constructors
        public shipment_package()
        {
            InitializeComponent();
            tabloAdi = "shipment_package";
        ...
        {
            shipment_packageVm k = new shipment_packageVm();
        ...
        {
            shipment_packageVm k = (shipment_packageVm)ModelVm;
