...
namespace B2C.Forms
{
    public partial class order_status : TanitimSablon
    {
        #region degiskenler
        private order_statusCntrl kulcntrl = new order_statusCntrl();
        #endregion
        #region Constructors
        public order_status()
        {
            InitializeComponent();
            tabloAdi = "order_status";
        ...
        {
            order_statusVm k = new order_statusVm();
        ...
        {
            order_statusVm k = (order_statusVm)ModelVm;
