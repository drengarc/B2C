...
namespace B2C.Forms
{
    public partial class customer_group : TanitimSablon
    {
        #region degiskenler
        private customer_groupCntrl kulcntrl = new customer_groupCntrl();
        #endregion
        #region Constructors
        public customer_group()
        {
            InitializeComponent();
            tabloAdi = "customer_group";
        ...
        {
            customer_groupVm k = new customer_groupVm();
        ...
        {
            customer_groupVm k = (customer_groupVm)ModelVm;
