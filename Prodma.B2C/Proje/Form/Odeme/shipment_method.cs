...
namespace B2C.Forms
{
    public partial class shipment_method : TanitimSablon
    {
        #region degiskenler
        private shipment_methodCntrl kulcntrl = new shipment_methodCntrl();
        #endregion
        #region Constructors
        public shipment_method()
        {
            InitializeComponent();
            tabloAdi = "shipment_method";
        ...
        {
            shipment_methodVm k = new shipment_methodVm();
        ...
        {
            shipment_methodVm k = (shipment_methodVm)ModelVm;
