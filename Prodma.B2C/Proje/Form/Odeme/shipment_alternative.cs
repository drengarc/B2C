...
namespace B2C.Forms
{
    public partial class shipment_alternative : TanitimSablon
    {
        #region degiskenler
        private shipment_alternativeCntrl kulcntrl = new shipment_alternativeCntrl();
        #endregion
        #region Constructors
        public shipment_alternative()
        {
            InitializeComponent();
            tabloAdi = "shipment_alternative";
        ...
        {
            shipment_alternativeVm k = new shipment_alternativeVm();
        ...
        {
            shipment_alternativeVm k = (shipment_alternativeVm)ModelVm;
