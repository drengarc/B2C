...
namespace B2C.Forms
{
    public partial class customer_basket : TanitimSablon
    {
        #region degiskenler
        private customer_basketCntrl kulcntrl = new customer_basketCntrl();
        #endregion
        #region Constructors
        public customer_basket()
        {
            InitializeComponent();
            tabloAdi = "customer_basket";
        ...
        {
            customer_basketVm k = new customer_basketVm();
        ...
        {
            //customer_basketVm k = (customer_basketVm)ModelVm;
