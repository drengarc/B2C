...
namespace B2C.Forms
{
    public partial class discount_category : TanitimSablon
    {
        #region degiskenler
        private discount_categoryCntrl kulcntrl = new discount_categoryCntrl();
        #endregion
        #region Constructors
        public discount_category()
        {
            InitializeComponent();
            tabloAdi = "discount_category";
        ...
        {
            discount_categoryVm k = new discount_categoryVm();
        ...
        {
            discount_categoryVm k = (discount_categoryVm)ModelVm;
