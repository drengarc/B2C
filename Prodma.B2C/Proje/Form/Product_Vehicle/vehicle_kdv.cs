...
namespace B2C.Forms
{
    public partial class vehicle_kdv : TanitimSablon
    {
        #region degiskenler
        private vehicle_kdvCntrl kulcntrl = new vehicle_kdvCntrl();
        #endregion
        #region Constructors
        public vehicle_kdv()
        {
            InitializeComponent();
            tabloAdi = "vehicle_kdv";
        ...
        {
            vehicle_kdvVm k = new vehicle_kdvVm();
        ...
        {
            vehicle_kdvVm k = (vehicle_kdvVm)ModelVm;
