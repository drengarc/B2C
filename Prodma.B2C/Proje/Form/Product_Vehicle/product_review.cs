...
namespace B2C.Forms
{
    public partial class product_review : TanitimSablon
    {
        #region degiskenler
        private product_reviewCntrl kulcntrl = new product_reviewCntrl();
        #endregion
        #region Constructors
        public product_review()
        {
            InitializeComponent();
            tabloAdi = "product_review";
        ...
        {
            product_reviewVm k = new product_reviewVm();
        ...
        {
            product_reviewVm k = (product_reviewVm)ModelVm;
