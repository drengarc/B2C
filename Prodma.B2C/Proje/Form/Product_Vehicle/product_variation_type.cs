...
namespace B2C.Forms
{
    public partial class product_variation_type : TanitimSablon
    {
        #region degiskenler
        private product_variation_typeCntrl kulcntrl = new product_variation_typeCntrl();
        #endregion
        #region Constructors
        public product_variation_type()
        {
            InitializeComponent();
            tabloAdi = "product_variation_type";
        ...
        {
            product_variation_typeVm k = new product_variation_typeVm();
        ...
        {
            product_variation_typeVm k = (product_variation_typeVm)ModelVm;
