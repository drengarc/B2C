...
namespace B2C.Forms
{
    public partial class product_images : TanitimSablon
    {
        #region degiskenler
        private product_imagesCntrl kulcntrl = new product_imagesCntrl();
        #endregion
        #region Constructors
        public product_images()
        {
            InitializeComponent();
            tabloAdi = "product_images";
        ...
        {
            product_imagesVm k = new product_imagesVm();
        ...
        {
            product_imagesVm k = (product_imagesVm)ModelVm;
