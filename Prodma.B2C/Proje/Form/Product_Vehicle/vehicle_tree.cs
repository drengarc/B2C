...
namespace B2C.Forms
{
    public partial class vehicle_tree : TanitimSablon
    {
        #region degiskenler
        private vehicle_treeCntrl kulcntrl = new vehicle_treeCntrl();
        #endregion
        #region Constructors
        public vehicle_tree()
        {
            InitializeComponent();
            tabloAdi = "vehicle_tree";
        ...
        {
            vehicle_treeVm k = new vehicle_treeVm();
            k.level = 2;
