...
namespace B2C.Forms
{
    public partial class product_vehicle : TanitimSablon
    {
        #region degiskenler
        private product_vehicleCntrl kulcntrl = new product_vehicleCntrl();
        #endregion
        #region Constructors
        public product_vehicle()
        {
            InitializeComponent();
            tabloAdi = "product_vehicle";
        ...
        {
            product_vehicleVm k = new product_vehicleVm();
        ...
        {
            product_vehicleVm k = (product_vehicleVm)ModelVm;
