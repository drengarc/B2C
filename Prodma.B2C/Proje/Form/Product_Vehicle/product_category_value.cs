...
namespace B2C.Forms
{
    public partial class product_category_value : TanitimSablon
    {
        #region degiskenler
        private product_category_valueCntrl kulcntrl = new product_category_valueCntrl();
        #endregion
        #region Constructors
        public product_category_value()
        {
            InitializeComponent();
            tabloAdi = "product_category_value";
        ...
        {
            product_category_valueVm k = new product_category_valueVm();
        ...
        {
            product_category_valueVm k = (product_category_valueVm)ModelVm;
