...
namespace B2C.Forms
{
    public partial class vehicle_motor_type : TanitimSablon
    {
        #region degiskenler
        private vehicle_motor_typeCntrl kulcntrl = new vehicle_motor_typeCntrl();
        #endregion
        #region Constructors
        public vehicle_motor_type()
        {
            InitializeComponent();
            tabloAdi = "vehicle_motor_type";
        ...
        {
            vehicle_motor_typeVm k = new vehicle_motor_typeVm();
        ...
        {
            vehicle_motor_typeVm k = (vehicle_motor_typeVm)ModelVm;
