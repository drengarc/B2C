...
namespace B2C.Forms
{
    public partial class product_tag : TanitimSablon
    {
        #region degiskenler
        private product_tagCntrl kulcntrl = new product_tagCntrl();
        #endregion
        #region Constructors
        public product_tag()
        {
            InitializeComponent();
            tabloAdi = "product_tag";
        ...
        {
            product_tagVm k = new product_tagVm();
        ...
        {
            product_tagVm k = (product_tagVm)ModelVm;
