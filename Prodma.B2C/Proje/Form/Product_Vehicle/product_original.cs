...
namespace B2C.Forms
{
    public partial class product_original : TanitimSablon
    {
        #region degiskenler
        private product_originalCntrl kulcntrl = new product_originalCntrl();
        #endregion
        #region Constructors
        public product_original()
        {
            InitializeComponent();
            tabloAdi = "product_original";
        ...
        {
            product_originalVm k = new product_originalVm();
        ...
        {
            product_originalVm k = (product_originalVm)ModelVm;
