...
namespace B2C.Forms
{
    public partial class product_tags : TanitimSablon
    {
        #region degiskenler
        private product_tagsCntrl kulcntrl = new product_tagsCntrl();
        #endregion
        #region Constructors
        public product_tags()
        {
            InitializeComponent();
            tabloAdi = "product_tags";
        ...
        {
            product_tagsVm k = new product_tagsVm();
        ...
        {
            product_tagsVm k = (product_tagsVm)ModelVm;
