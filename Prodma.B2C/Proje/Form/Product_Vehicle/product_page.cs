...
namespace B2C.Forms
{
    public partial class product_page : TanitimSablon
    {
        #region degiskenler
        private product_pageCntrl kulcntrl = new product_pageCntrl();
        #endregion
        #region Constructors
        public product_page()
        {
            InitializeComponent();
            tabloAdi = "product_page";
        ...
        {
            product_pageVm k = new product_pageVm();
        ...
        {
            product_pageVm k = (product_pageVm)ModelVm;
