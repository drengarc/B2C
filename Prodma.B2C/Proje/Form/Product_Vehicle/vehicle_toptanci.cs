...
namespace B2C.Forms
{
    public partial class vehicle_toptanci : TanitimSablon
    {
        #region degiskenler
        private vehicle_toptanciCntrl kulcntrl = new vehicle_toptanciCntrl();
        #endregion
        #region Constructors
        public vehicle_toptanci()
        {
            InitializeComponent();
            tabloAdi = "vehicle_toptanci";
        ...
        {
            vehicle_toptanciVm k = new vehicle_toptanciVm();
        ...
        {
            vehicle_toptanciVm k = (vehicle_toptanciVm)ModelVm;
