...
namespace B2C.Forms
{
    public partial class product_category_choice : TanitimSablon
    {
        #region degiskenler
        private product_category_choiceCntrl kulcntrl = new product_category_choiceCntrl();
        #endregion
        #region Constructors
        public product_category_choice()
        {
            InitializeComponent();
            tabloAdi = "product_category_choice";
        ...
        {
            product_category_choiceVm k = new product_category_choiceVm();
        ...
        {
            product_category_choiceVm k = (product_category_choiceVm)ModelVm;
