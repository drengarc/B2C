...
namespace B2C.Forms
{
    public partial class auth_user_groups : TanitimSablon
    {
        #region degiskenler
        private auth_user_groupsCntrl kulcntrl = new auth_user_groupsCntrl();
        #endregion
        #region Constructors
        public auth_user_groups()
        {
            InitializeComponent();
            tabloAdi = "auth_user_groups";
        ...
        {
            auth_user_groupsVm k = new auth_user_groupsVm();
        ...
        {
            auth_user_groupsVm k = (auth_user_groupsVm)ModelVm;
