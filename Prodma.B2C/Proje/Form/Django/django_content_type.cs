...
namespace B2C.Forms
{
    public partial class django_content_type : TanitimSablon
    {
        #region degiskenler
        private django_content_typeCntrl kulcntrl = new django_content_typeCntrl();
        #endregion
        #region Constructors
        public django_content_type()
        {
            InitializeComponent();
            tabloAdi = "django_content_type";
        ...
        {
            django_content_typeVm k = new django_content_typeVm();
        ...
        {
            django_content_typeVm k = (django_content_typeVm)ModelVm;
