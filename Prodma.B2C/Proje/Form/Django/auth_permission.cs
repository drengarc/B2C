...
namespace B2C.Forms
{
    public partial class auth_permission : TanitimSablon
    {
        #region degiskenler
        private auth_permissionCntrl kulcntrl = new auth_permissionCntrl();
        #endregion
        #region Constructors
        public auth_permission()
        {
            InitializeComponent();
            tabloAdi = "auth_permission";
        ...
        {
            auth_permissionVm k = new auth_permissionVm();
        ...
        {
            auth_permissionVm k = (auth_permissionVm)ModelVm;
