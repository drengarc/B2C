...
namespace B2C.Forms
{
    public partial class django_session : TanitimSablon
    {
        #region degiskenler
        private django_sessionCntrl kulcntrl = new django_sessionCntrl();
        #endregion
        #region Constructors
        public django_session()
        {
            InitializeComponent();
            tabloAdi = "django_session";
        ...
        {
            django_sessionVm k = new django_sessionVm();
        ...
        {
            django_sessionVm k = (django_sessionVm)ModelVm;
