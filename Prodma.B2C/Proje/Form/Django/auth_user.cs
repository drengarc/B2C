...
namespace B2C.Forms
{
    public partial class auth_user : TanitimSablon
    {
        #region degiskenler
        private auth_userCntrl kulcntrl = new auth_userCntrl();
        #endregion
        #region Constructors
        public auth_user()
        {
        ...
        {
            auth_userVm k = (auth_userVm)ModelVm;
