...
namespace B2C.Forms
{
    public partial class admin_tools_dashboard_preferences : TanitimSablon
    {
        #region degiskenler
        private admin_tools_dashboard_preferencesCntrl kulcntrl = new admin_tools_dashboard_preferencesCntrl();
        #endregion
        #region Constructors
        public admin_tools_dashboard_preferences()
        {
            InitializeComponent();
            tabloAdi = "admin_tools_dashboard_preferences";
        ...
        {
            admin_tools_dashboard_preferencesVm k = new admin_tools_dashboard_preferencesVm();
        ...
        {
            admin_tools_dashboard_preferencesVm k = (admin_tools_dashboard_preferencesVm)ModelVm;
