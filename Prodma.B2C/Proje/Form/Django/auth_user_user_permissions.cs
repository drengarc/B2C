...
namespace B2C.Forms
{
    public partial class auth_user_user_permissions : TanitimSablon
    {
        #region degiskenler
        private auth_user_user_permissionsCntrl kulcntrl = new auth_user_user_permissionsCntrl();
        #endregion
        #region Constructors
        public auth_user_user_permissions()
        {
            InitializeComponent();
            tabloAdi = "auth_user_user_permissions";
        ...
        {
            auth_user_user_permissionsVm k = new auth_user_user_permissionsVm();
        ...
        {
            auth_user_user_permissionsVm k = (auth_user_user_permissionsVm)ModelVm;
