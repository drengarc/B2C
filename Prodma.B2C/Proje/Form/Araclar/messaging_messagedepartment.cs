...
namespace B2C.Forms
{
    public partial class messaging_messagedepartment : TanitimSablon
    {
        #region degiskenler
        private messaging_messagedepartmentCntrl kulcntrl = new messaging_messagedepartmentCntrl();
        #endregion
        #region Constructors
        public messaging_messagedepartment()
        {
            InitializeComponent();
            tabloAdi = "messaging_messagedepartment";
        ...
        {
            messaging_messagedepartmentVm k = new messaging_messagedepartmentVm();
        ...
        {
            messaging_messagedepartmentVm k = (messaging_messagedepartmentVm)ModelVm;
