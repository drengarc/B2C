...
namespace B2C.Forms
{
    public partial class module_pricedropalert_customer : TanitimSablon
    {
        #region degiskenler
        private module_pricedropalert_customerCntrl kulcntrl = new module_pricedropalert_customerCntrl();
        #endregion
        #region Constructors
        public module_pricedropalert_customer()
        {
            InitializeComponent();
            tabloAdi = "module_pricedropalert_customer";
        ...
        {
            module_pricedropalert_customerVm k = new module_pricedropalert_customerVm();
        ...
        {
            module_pricedropalert_customerVm k = (module_pricedropalert_customerVm)ModelVm;
