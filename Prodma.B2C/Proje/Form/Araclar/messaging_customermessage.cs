...
namespace B2C.Forms
{
    public partial class messaging_customermessage : TanitimSablon
    {
        #region degiskenler
        private messaging_customermessageCntrl kulcntrl = new messaging_customermessageCntrl();
        #endregion
        #region Constructors
        public messaging_customermessage()
        {
            InitializeComponent();
            tabloAdi = "messaging_customermessage";
        ...
        {
            messaging_customermessageVm k = new messaging_customermessageVm();
        ...
        {
            messaging_customermessageVm k = (messaging_customermessageVm)ModelVm;
