...
namespace B2C.Forms
{
    public partial class newsletter : TanitimSablon
    {
        #region degiskenler
        private newsletterCntrl kulcntrl = new newsletterCntrl();
        #endregion
        #region Constructors
        public newsletter()
        {
        ...
        {
            newsletterVm k = new newsletterVm();
        ...
        {
            newsletterVm k = (newsletterVm)ModelVm;
