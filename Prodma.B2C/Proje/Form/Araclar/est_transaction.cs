...
namespace B2C.Forms
{
    public partial class est_transaction : TanitimSablon
    {
        #region degiskenler
        private est_transactionCntrl kulcntrl = new est_transactionCntrl();
        #endregion
        #region Constructors
        public est_transaction()
        {
            InitializeComponent();
            tabloAdi = "est_transaction";
        ...
        {
            est_transactionVm k = new est_transactionVm();
        ...
        {
            est_transactionVm k = (est_transactionVm)ModelVm;
