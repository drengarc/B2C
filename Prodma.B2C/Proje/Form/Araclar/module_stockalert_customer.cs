...
namespace B2C.Forms
{
    public partial class module_stockalert_customer : TanitimSablon
    {
        #region degiskenler
        private module_stockalert_customerCntrl kulcntrl = new module_stockalert_customerCntrl();
        #endregion
        #region Constructors
        public module_stockalert_customer()
        {
            InitializeComponent();
            tabloAdi = "module_stockalert_customer";
        ...
        {
            module_stockalert_customerVm k = new module_stockalert_customerVm();
        ...
        {
            module_stockalert_customerVm k = (module_stockalert_customerVm)ModelVm;
