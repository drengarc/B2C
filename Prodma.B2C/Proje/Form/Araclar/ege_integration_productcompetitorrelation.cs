...
namespace B2C.Forms
{
    public partial class ege_integration_productcompetitorrelation : TanitimSablon
    {
        #region degiskenler
        private ege_integration_productcompetitorrelationCntrl kulcntrl = new ege_integration_productcompetitorrelationCntrl();
        #endregion
        #region Constructors
        public ege_integration_productcompetitorrelation()
        {
            InitializeComponent();
            tabloAdi = "ege_integration_productcompetitorrelation";
        ...
        {
            ege_integration_productcompetitorrelationVm k = new ege_integration_productcompetitorrelationVm();
        ...
        {
            ege_integration_productcompetitorrelationVm k = (ege_integration_productcompetitorrelationVm)ModelVm;
