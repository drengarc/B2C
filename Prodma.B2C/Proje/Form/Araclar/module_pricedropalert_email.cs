...
namespace B2C.Forms
{
    public partial class module_pricedropalert_email : TanitimSablon
    {
        #region degiskenler
        private module_pricedropalert_emailCntrl kulcntrl = new module_pricedropalert_emailCntrl();
        #endregion
        #region Constructors
        public module_pricedropalert_email()
        {
            InitializeComponent();
            tabloAdi = "module_pricedropalert_email";
        ...
        {
            module_pricedropalert_emailVm k = new module_pricedropalert_emailVm();
        ...
        {
            module_pricedropalert_emailVm k = (module_pricedropalert_emailVm)ModelVm;
