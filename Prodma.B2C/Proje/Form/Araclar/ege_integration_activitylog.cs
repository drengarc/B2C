...
namespace B2C.Forms
{
    public partial class ege_integration_activitylog : TanitimSablon
    {
        #region degiskenler
        private ege_integration_activitylogCntrl kulcntrl = new ege_integration_activitylogCntrl();
        #endregion
        #region Constructors
        public ege_integration_activitylog()
        {
            InitializeComponent();
            tabloAdi = "ege_integration_activitylog";
        ...
        {
            ege_integration_activitylogVm k = new ege_integration_activitylogVm();
        ...
        {
            ege_integration_activitylogVm k = (ege_integration_activitylogVm)ModelVm;
