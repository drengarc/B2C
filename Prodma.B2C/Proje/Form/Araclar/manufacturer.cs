...
namespace B2C.Forms
{
    public partial class manufacturer : TanitimSablon
    {
        #region degiskenler
        private manufacturerCntrl kulcntrl = new manufacturerCntrl();
        #endregion
        #region Constructors
        public manufacturer()
        {
            InitializeComponent();
            tabloAdi = "manufacturer";
        ...
        {
            manufacturerVm k = new manufacturerVm();
        ...
        {
            manufacturerVm k = (manufacturerVm)ModelVm;
