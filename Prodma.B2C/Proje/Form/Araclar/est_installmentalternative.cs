...
namespace B2C.Forms
{
    public partial class est_installmentalternative : TanitimSablon
    {
        #region degiskenler
        private est_installmentalternativeCntrl kulcntrl = new est_installmentalternativeCntrl();
        #endregion
        #region Constructors
        public est_installmentalternative()
        {
            InitializeComponent();
            tabloAdi = "est_installmentalternative";
        ...
        {
            est_installmentalternativeVm k = new est_installmentalternativeVm();
        ...
        {
            est_installmentalternativeVm k = (est_installmentalternativeVm)ModelVm;
