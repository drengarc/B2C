...
namespace B2C.Forms
{
    public partial class simit_menusection : TanitimSablon
    {
        #region degiskenler
        private simit_menusectionCntrl kulcntrl = new simit_menusectionCntrl();
        #endregion
        #region Constructors
        public simit_menusection()
        {
            InitializeComponent();
            tabloAdi = "simit_menusection";
        ...
        {
            simit_menusectionVm k = new simit_menusectionVm();
        ...
        {
            simit_menusectionVm k = (simit_menusectionVm)ModelVm;
