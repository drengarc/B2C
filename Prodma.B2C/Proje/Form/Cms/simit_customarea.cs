...
namespace B2C.Forms
{
    public partial class simit_customarea : TanitimSablon
    {
        #region degiskenler
        private simit_customareaCntrl kulcntrl = new simit_customareaCntrl();
        #endregion
        #region Constructors
        public simit_customarea()
        {
            InitializeComponent();
            tabloAdi = "simit_customarea";
        ...
        {
            simit_customareaVm k = new simit_customareaVm();
        ...
        {
            simit_customareaVm k = (simit_customareaVm)ModelVm;
