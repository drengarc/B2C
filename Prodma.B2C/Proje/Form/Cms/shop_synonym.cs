...
namespace B2C.Forms
{
    public partial class shop_synonym : TanitimSablon
    {
        #region degiskenler
        private shop_synonymCntrl kulcntrl = new shop_synonymCntrl();
        #endregion
        #region Constructors
        public shop_synonym()
        {
            InitializeComponent();
            tabloAdi = "shop_synonym";
        ...
        {
            shop_synonymVm k = new shop_synonymVm();
        ...
        {
            shop_synonymVm k = (shop_synonymVm)ModelVm;
