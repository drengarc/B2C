...
namespace B2C.Forms
{
    public partial class banner_area : TanitimSablon
    {
        #region degiskenler
        private banner_areaCntrl kulcntrl = new banner_areaCntrl();
        #endregion
        #region Constructors
        public banner_area()
        {
            InitializeComponent();
            tabloAdi = "banner_area";
        ...
        {
            banner_areaVm k = new banner_areaVm();
        ...
        {
            banner_areaVm k = (banner_areaVm)ModelVm;
