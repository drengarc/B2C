...
namespace B2C.Forms
{
    public partial class simit_menu : TanitimSablon
    {
        #region degiskenler
        private simit_menuCntrl kulcntrl = new simit_menuCntrl();
        #endregion
        #region Constructors
        public simit_menu()
        {
        ...
        {
            simit_menuVm k = new simit_menuVm();
        ...
        {
            simit_menuVm k = (simit_menuVm)ModelVm;
