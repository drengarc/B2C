...
namespace B2C.Forms
{
    public partial class simit_customareacategory : TanitimSablon
    {
        #region degiskenler
        private simit_customareacategoryCntrl kulcntrl = new simit_customareacategoryCntrl();
        #endregion
        #region Constructors
        public simit_customareacategory()
        {
            InitializeComponent();
            tabloAdi = "simit_customareacategory";
        ...
        {
            simit_customareacategoryVm k = new simit_customareacategoryVm();
        ...
        {
            simit_customareacategoryVm k = (simit_customareacategoryVm)ModelVm;
