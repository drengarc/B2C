...
namespace B2C.Forms
{
    public partial class shop_config : TanitimSablon
    {
        #region degiskenler
        private shop_configCntrl kulcntrl = new shop_configCntrl();
        #endregion
        #region Constructors
        public shop_config()
        {
            InitializeComponent();
            tabloAdi = "shop_config";
        ...
        {
            shop_configVm k = new shop_configVm();
        ...
        {
            shop_configVm k = (shop_configVm)ModelVm;
