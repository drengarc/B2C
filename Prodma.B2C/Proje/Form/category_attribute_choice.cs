...
namespace B2C.Forms
{
    public partial class category_attribute_choice : TanitimSablon
    {
        #region degiskenler
        private category_attribute_choiceCntrl kulcntrl = new category_attribute_choiceCntrl();
        #endregion
        #region Constructors
        public category_attribute_choice()
        {
            InitializeComponent();
            tabloAdi = "category_attribute_choice";
        ...
        {
            category_attribute_choiceVm k = new category_attribute_choiceVm();
        ...
        {
            category_attribute_choiceVm k = (category_attribute_choiceVm)ModelVm;
