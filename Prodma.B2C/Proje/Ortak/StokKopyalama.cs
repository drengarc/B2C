...
namespace B2C.Forms
{
    public partial class StokKopyalama : Islemler
    {
        public StokKopyalama()
        {
            InitializeComponent();
            ...
            YardimciIslemlerKontrols.InvokeChlSet(Prodma.DataAccessB2C.ListService.Getproduct_id((int)ListServiceTipEn.LISTE, 0, 0, 0, 0, "", "", 1), auth_userchl);
        }
        ...
        void IslemYap()
        {
            B2cSistemService.StokUpdate(parameterIslemler);
        ...
        public override bool IslemKontrol(Control cntrl)
        {
            ...
            if (param1 != "") parameterIslemler.Add("productId", param1);
            DialogResult res = MessageBox.Show("Stok Kopyalama İşlemi Gerçekleştirilsin Mi?", "", MessageBoxButtons.YesNo);
