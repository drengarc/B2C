...
namespace Prodma.Sistem.Forms
{
    ...
    { 
        ...
        public YaziciAyarKopyalama()
        {
            ...
            YardimciIslemler.InvokeLueContainSet("FATURA_IRSALIYE_AYAR_TIP_ID", FATURA_AYARlke);
        }
        ...
        public override bool IslemKontrol(Control cntrl)
        {
                ...
                //    return false;
                //}
                if (YardimciIslemler.UyariVer("Yazıcı Ayarları Kopyalanacak Emin Misiniz?") == false)
                {
                    return false;
                } 
                return true;
