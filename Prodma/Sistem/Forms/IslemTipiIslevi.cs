...
{
    public partial class IslemTipiIslevi : TanitimSablon
    {
        #region degiskenler
        private IslemTipiIsleviCntrl kulcntrl = new IslemTipiIsleviCntrl();
        #endregion
        #region Constructors
        public IslemTipiIslevi()
        {
            
            InitializeComponent();
            tabloAdi = "ISLEM_TIPI_ISLEVI";
        ...
        private void Tab_Gizle_Ekle()
        {
            ...
            tabPage1.Text = "İşlem Tipi İşlevi";
        ...
        {
            IslemTipiIsleviVm k = new IslemTipiIsleviVm();
        ...
        {
            IslemTipiIsleviVm k = (IslemTipiIsleviVm)ModelVm;
