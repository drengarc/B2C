...
{
    public partial class IslemCins : TanitimSablon
    {
        #region degiskenler
       
        private IslemCinsCntrl kulcntrl = new IslemCinsCntrl();
        #endregion
        #region Constructors
        public IslemCins()
        {
        ...
        {
            tabPage1.Text = "Islem Cins Bilgi Giriş";
        ...
        {
            IslemCinsVm k = (IslemCinsVm)ModelVm;
