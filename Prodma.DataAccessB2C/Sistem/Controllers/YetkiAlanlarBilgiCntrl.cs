...
{
    public class YetkiAlanlarBilgiCntrl : BaseCtrl<YetkiAlanlarBilgiVm, int>
    {
        YetkiAlanlarBilgiService Service = new YetkiAlanlarBilgiService();
        public override List<YetkiAlanlarBilgiVm> doListe_Al(YetkiAlanlarBilgiVm entity)
        {

            return Service.Service_Liste_Al(entity);  
             
        }         
         public override void doEkle(YetkiAlanlarBilgiVm entity)
        {
         ...
         public override void doGuncelle(YetkiAlanlarBilgiVm entity, int id)
        {
         ...
         public override void doSil(int id, YetkiAlanlarBilgiVm  entity)
        {
