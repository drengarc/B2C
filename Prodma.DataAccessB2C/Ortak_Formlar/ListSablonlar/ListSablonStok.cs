...
namespace Prodma.WinForms
{
    ...
    public partial class ListSablonStok : Sablon
    {
        ...
        public void ListSablon_Load(object sender, EventArgs e)
        {
            ...
            if (ListeOzellikleri.CariStokModelli == (int)ListeCariStokModelEn.Hayir)
            {
                LISTE_SECIMIlke.Visible = false;
            }
            else
        ...
        private void InitializeComponent()
        {
            ...
            // simpleButton1
            // 
            this.simpleButton1.BackgroundImage = global::Prodma.DataAccess.Resource1.zoom;
            this.simpleButton1.Image = global::Prodma.DataAccess.Resource1.zoom;
        ...
        void Listele()
        {
                ...
                if (ListeOzellikleri.listSablonTip ==  (int)ListSablonEn.DinamikUpdate)
                {
                    ...
                    list = ListDenemeService.GetALANLAR(ListeOzellikleri.dinamikUpdateTabloTip);
                    if (ListeOzellikleri.dinamikUpdateTabloTip == "STOK" || ListeOzellikleri.dinamikUpdateTabloTip == "CARI")
                    {
                        ...
                        ListHelper.Gridi_OlusturbyList(list, gridControl.gridView1, gridControl.gridControl1, 0, ListeOzellikleri.dinamikUpdateTabloTip, true, true);
                    }
                    else
                    {
                        if (LISTE_SECIMIlke.Visible == true)
                        {
                            ...
                            {
                                ListHelper.Gridi_OlusturbyList(list, gridControl.gridView1, gridControl.gridControl1, 0, "", true, true);

                            }
                            else if (Convert.ToInt32(LISTE_SECIMIlke.EditValue) == (int)ListSablonListeSecimiEn.Tum)
                            {
                                ListHelper.Gridi_OlusturbyList(list, gridControl.gridView1, gridControl.gridControl1, 0, "", true, true);
                                ListHelper.Grid_Olustur("Satis.StokAmbar.Models", "StokListVm", "Prodma.DataAccess", gridControl.gridView1, ListeOzellikleri.toplamAlanlari, gridOzellikleri);
                            ...
                            else if (Convert.ToInt32(LISTE_SECIMIlke.EditValue) == (int)ListSablonListeSecimiEn.TumDetayli)
                            {
                                ListHelper.Gridi_OlusturbyList(list, gridControl.gridView1, gridControl.gridControl1, 0, "", true, true);
                                ListHelper.Grid_Olustur("Satis.StokAmbar.Models", "StokListVm", "Prodma.DataAccess", gridControl.gridView1, ListeOzellikleri.toplamAlanlari, gridOzellikleri);
                                ListHelper.Grid_Olustur("Satis.StokAmbar.Models", "StokHesaplananBilgilerVm", "Prodma.DataAccess", gridControl.gridView1, ListeOzellikleri.toplamAlanlari, gridOzellikleri);
                            }
                            //ListHelper.Grid_Olustur_Tum_Kayitlar(ListeOzellikleri.modelPath, ListeOzellikleri.modelName, "Prodma.DataAccess", gridControl.gridView1, gridControl.gridControl1, ListeOzellikleri.toplamAlanlari, ListeOzellikleri.CariStokModelli, gridOzellikleri);
                ...
                {
                    gridControl.gridView1.Columns.Clear();
                    if (dinamikAlanlar != null) ListHelper.Grid_Olustur_Dinamik1(ListeOzellikleri.modelPath, ListeOzellikleri.modelName, "Prodma.DataAccess", gridControl.gridView1, gridControl.gridControl1, ListeOzellikleri.toplamAlanlari, dinamikAlanlar, dinamikAltAlan, parametersForm);
                }
                else
                {
                    gridControl.gridView1.Columns.Clear();
                    ...
                    {
                        ListHelper.Grid_Olustur(ListeOzellikleri.modelPath, ListeOzellikleri.modelName, "Prodma.DataAccess", gridControl.gridView1, ListeOzellikleri.toplamAlanlari, gridOzellikleri);
                    }
                }
        ...
        public void gridColumnYenile()
        {
            ...
            {
                string[] grupIndex = setValues["GRUPLAMA"].Split(',');
                for (int i = 0; i < grupIndex.Length; i++)
                {
                    gridControl.gridView1.Columns[Convert.ToInt32(grupIndex[i])].GroupIndex = i;
                }
    ...
    public class ListSablonOzellikleriVm
    {
        ...
        public int CariStokModelli { get; set; }
